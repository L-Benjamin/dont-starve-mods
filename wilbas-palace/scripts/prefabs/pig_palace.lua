...
local function creatInterior(inst, name)
    if not inst:HasTag("spawned_shop") then
        ...
        -- MOD FEATURES
        local righthallID = interior_spawner:GetNewID()
        local wilbasroomID = interior_spawner:GetNewID()
        local gardenID = interior_spawner:GetNewID()
        local kitchenID = interior_spawner:GetNewID()
        -- /MOD FEATURES
        ...
        -- MOD FEATURES
        local torighthall_door_def =
        {
            my_door_id = "palace_courtroom_EAST",
            target_door_id = "palace_righthall_WEST",
            target_interior = righthallID,
        }
        -- /MOD FEATURES
        ...
        addprops =
        {
            ...
            -- MOD FEATURES
            { name = "prop_door", x_offset = 0, z_offset = 26/2, animdata = {bank = "wall_decals_palace", build = "interior_wall_decals_palace", anim = "door_sidewall", background = true }, 
                my_door_id = torighthall_door_def.my_door_id, target_door_id = torighthall_door_def.target_door_id, target_interior = torighthall_door_def.target_interior, rotation = 90, addtags = {"lockable_door","door_east"} },
            -- /MOD FEATURES
        ...
        addprops =
        {
            ...
            { name = "window_round_light_backwall", x_offset = -18/2, z_offset =  18/3, rotation = -90 }, 
            { name = "window_palace",               x_offset = -12/2, z_offset =  18/3, rotation =  90 }, 
        ...
        local topalace_door_def =
        {
            my_door_id = "palace_righthall_WEST",
            target_door_id = "palace_courtroom_EAST",
            target_interior = palaceID,
        }

        local towilbasroom_door_def =
        {
            my_door_id = "palace_righthall_EAST",
            target_door_id = "palace_wilbasroom_WEST",
            target_interior = wilbasroomID,
        }

        local togarden_door_def =
        {
            my_door_id = "palace_righthall_NORTH",
            target_door_id = "palace_garden_SOUTH",
            target_interior = gardenID,
        }
        ...
        addprops =
        {
            ...
            { name = "prop_door", x_offset =0, z_offset = -18/2, animdata = {bank = "wall_decals_palace", build = "interior_wall_decals_palace", anim = "door_sidewall", background = true }, 
                my_door_id = topalace_door_def.my_door_id, target_door_id = topalace_door_def.target_door_id, target_interior = topalace_door_def.target_interior, rotation = -90, flip = true, addtags = {"lockable_door", "door_west"} },

            { name = "prop_door", x_offset =0, z_offset = 18/2, animdata = {bank = "wall_decals_palace", build = "interior_wall_decals_palace", anim = "door_sidewall", background = true }, 
                my_door_id = towilbasroom_door_def.my_door_id, target_door_id = towilbasroom_door_def.target_door_id, target_interior = towilbasroom_door_def.target_interior, rotation = 90, addtags = {"lockable_door", "door_east"} },

            { name = "prop_door", x_offset = -depth/2, z_offset = 0, animdata = { bank = "player_house_doors", build = "player_house_doors", anim = "iron_door_open_north" },
                my_door_id = togarden_door_def.my_door_id, target_door_id = togarden_door_def.target_door_id, target_interior = togarden_door_def.target_interior, rotation = -90, angle=0, addtags = { "lockable_door", "door_north" }},
            ...
            { name = "deco_cityhall_picture1", x_offset =   12/3, z_offset =  18/2, rotation = 90 },
            { name = "deco_cityhall_picture1", x_offset =  -12/3, z_offset = -18/2, rotation = 90, flip = true },

            { name = "pigman_royalguard_2", x_offset = 0, z_offset = 0 },
        } 

        interior_spawner:CreateRoom("generic_interior", width, 12, depth, name, righthallID, addprops, {}, walltexture, floortexture, minimaptexture, cityID ,"images/colour_cubes/pigshop_interior_cc.tex", nil, nil, "palace", "PALACE","STONE")
        ...
        local torighthall_door_def =
        {
            my_door_id = "palace_wilbasroom_WEST",
            target_door_id = "palace_righthall_EAST",
            target_interior = righthallID,
        }

        floortexture = "levels/textures/interiors/floor_shag_carpet.tex"
        ...
        addprops =
        {
            ...
            { name = "prop_door", x_offset = 0, z_offset = -15/2, animdata = {bank = "player_house_doors", build = "player_house_doors", anim = "wood_door_open_west", background = true }, 
                my_door_id = torighthall_door_def.my_door_id, target_door_id =torighthall_door_def.target_door_id, target_interior = torighthall_door_def.target_interior, rotation = -90, addtags = {"lockable_door", "door_west"} },

            { name = "shelves_wood", x_offset = -10/2, z_offset = -15/5, rotation = -90, shelfitems={{1,"trinket_7"},{4,"trinket_11"},{5,"trinket_1"}}, addtags={"playercrafted"} },

            { name = "deco_table_chess", x_offset = 4, z_offset = -4, addtags={"playercrafted"} }, 
            { name = "deco_chair_stuffed", x_offset = 3, z_offset = -5, flip=true, addtags={"playercrafted"} }, 
            { name = "deco_chair_stuffed", x_offset = 3, z_offset = -3, addtags={"playercrafted"} }, 
            { name = "deco_lamp_elizabethan", x_offset = 2, z_offset = -4, addtags={"playercrafted"} }, 

            { name = "deco_table_banker", x_offset = 1, z_offset = 3.5, addtags={"playercrafted"} },      
            { name = "deco_chair_lounge", x_offset = -0.5, z_offset = 4, addtags={"playercrafted"} }, 
            { name = "deco_plantholder_fernstand", x_offset = -4, z_offset = 1.5, addtags={"playercrafted"} },

            { name = "swinging_light_floral_bloomer", x_offset = 1,  z_offset =  3.5, rotation = -90, addtags={"playercrafted"} },
            { name = "swinging_light_floral_bloomer", x_offset = -10/4,  z_offset =  -15/3, rotation = -90, addtags={"playercrafted"} },
            { name = "window_tall_curtain", x_offset = 1, z_offset = 15/2, rotation = 90, addtags={"playercrafted"} },            
            
        }

        interior_spawner:CreateRoom("generic_interior", width, nil, depth, name..wilbasroomID, wilbasroomID, addprops, {}, walltexture, floortexture, minimaptexture, nil, "images/colour_cubes/pigshop_interior_cc.tex", nil, true, "inside", "HOUSE", "WOOD")
        interior_spawner:CreatePlayerHome(name..wilbasroomID, wilbasroomID)
        ...
        local torighthall_door_def =
        {
            my_door_id = "palace_garden_SOUTH",
            target_door_id = "palace_righthall_NORTH",
            target_interior = righthallID,
        }

        local tokitchen_door_def =
        {
            my_door_id = "palace_garden_WEST",
            target_door_id = "palace_kitchen_EAST",
            target_interior = kitchenID,
        }

        floortexture   = "levels/textures/ground_noise_checkeredlawn.tex"
        walltexture    = "levels/textures/interiors/wall_royal_high.tex"
        minimaptexture = "levels/textures/ground_noise_checkeredlawn.tex" --"levels/textures/map_interior/mini_floor_marble_royal.tex"

        addprops = {}
        addprops = {
            { name = "prop_door", x_offset = 18/2, z_offset = 0, animdata = { bank = "player_house_doors", build = "player_house_doors", anim = "iron_door_open_south"},
                my_door_id = torighthall_door_def.my_door_id, target_door_id = torighthall_door_def.target_door_id, target_interior = torighthall_door_def.target_interior, rotation = -90, angle=0, addtags = { "lockable_door", "door_south" } },
            { name = "prop_door_shadow", x_offset = 9, z_offset = 0, animdata = {bank = "palace_door", build = "palace_door", anim = "south_floor"} },

            { name = "prop_door", x_offset = 0, z_offset = -26/2, animdata = { bank = "player_house_doors", build = "player_house_doors", anim = "iron_door_open_west", background = true},
                my_door_id = tokitchen_door_def.my_door_id, target_door_id = tokitchen_door_def.target_door_id, target_interior = tokitchen_door_def.target_interior, rotation = -90, angle=0, addtags = { "lockable_door", "door_west" } },

            { name = "deco_roomglow_large", x_offset = 0, z_offset = 0 },

            { name = "palace_garden_lamp", x_offset = 0, z_offset =  26/6 },
            { name = "palace_garden_lamp", x_offset = 0, z_offset = -26/6 },
            ...
            { name = "palace_garden_light", x_offset = 0, z_offset = 0 },

            { name = "window_large_square_backwall", x_offset = -18/2, z_offset = -3*26/8 },
            { name = "window_large_square_backwall", x_offset = -18/2, z_offset =  3*26/8 },
            { name = "window_large_square_backwall", x_offset = -18/2, z_offset = -26/8 },
            { name = "window_large_square_backwall", x_offset = -18/2, z_offset =  26/8 },

            { name = "palace_fountain", x_offset =  0, z_offset = 0 },

            { name = "palace_lawnornament", x_offset = -18/4, z_offset =  26/3 },
            { name = "palace_lawnornament", x_offset = -18/4, z_offset = -26/3 },
            { name = "palace_lawnornament", x_offset =  18/4, z_offset =  26/3 },
            { name = "palace_lawnornament", x_offset =  18/4, z_offset = -26/3 },

            { name = "deco_plantholder_marble", x_offset = -18/4, z_offset =  26/3 - 1.5 },
            { name = "deco_plantholder_marble", x_offset = -18/4, z_offset = -26/3 + 1.5 },
            { name = "deco_plantholder_marble", x_offset =  18/4, z_offset =  26/3 - 1.5 },
            { name = "deco_plantholder_marble", x_offset =  18/4, z_offset = -26/3 + 1.5 },
        }
        ...
        for i = 0, 10 do
            table.insert( addprops, { name = "palace_hedge", x_offset = -18/2 + 1, z_offset = -13 + i } )
            table.insert( addprops, { name = "palace_hedge", x_offset =  18/2 - 1, z_offset = -13 + i } )
        end
        for i = 11, 14 do
            table.insert( addprops, { name = "palace_hedge", x_offset = -18/2 + 1, z_offset = -13 + i } )
        ...
        interior_spawner:CreateRoom("generic_interior", width, 13, depth, name, gardenID, addprops, {}, walltexture, floortexture, minimaptexture, cityID, "images/colour_cubes/pork_temperate_day_cc.tex", nil, nil, "default", "dontstarve_DLC003/amb/temperate/city", "CARPET")
        ...
        local togarden_door_def =
        {
            my_door_id = "palace_kitchen_EAST",
            target_door_id = "palace_garden_WEST",
            target_interior = gardenID,
        }
        ...
        addprops =
        {
            ...
            { name = "prop_door", x_offset = 0, z_offset = 15/2, animdata = {bank = "player_house_doors", build = "player_house_doors", anim = "plate_door_open_east", background = true }, 
                my_door_id = togarden_door_def.my_door_id, target_door_id = togarden_door_def.target_door_id, target_interior = togarden_door_def.target_interior, rotation = -90, addtags = {"lockable_door", "door_east"} },

            { name = "palace_fridge", x_offset = -4.5, z_offset = 4.5, rotation= -90 },
            { name = "palace_fridge", x_offset = -4.5, z_offset = 0.5, rotation= -90 },
            ...
            { name = "deco_deli_basket",              x_offset =  3, z_offset = -width/2+2 },
            { name = "deco_deli_stove_metal_side",    x_offset =  2, z_offset = -width/2 },
            ...
            { name = "window_round_backwall", x_offset = -5, z_offset = -3 },
            { name = "window_round_light_backwall",  x_offset = -5, z_offset = -3 },
            { name = "swinging_light_basic_metal", x_offset = -1.3, z_offset = -width/6+0.5 }, 

            { name = "pigman_banker", x_offset = 0, z_offset = 0 },
        }

        interior_spawner:CreateRoom("generic_interior", width, nil, depth, name, kitchenID, addprops, {}, walltexture, floortexture, minimaptexture, cityID ,"images/colour_cubes/pigshop_interior_cc.tex", nil, nil, "inside", "STORE", "WOOD")
        -- /MOD FEATURES
